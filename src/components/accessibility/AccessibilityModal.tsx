            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 hover:border-teal-300 bg-slate-50/50 hover:bg-teal-50/20 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-slate-900 block">Large Text Mode</span>
                    <span className="text-xs text-slate-500">Increases base font size and button labels for easier reading</span>
                  </div>
                </div>
                <input
                  type="checkbox"
                  ...
                  onChange={e => {
                    ...
                    showToast(e.target.checked ? 'Large Text Mode enabled' : 'Standard Text Mode restored', 'info');
                  }}
              ...
              <label className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 hover:border-teal-300 bg-slate-50/50 hover:bg-teal-50/20 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-slate-900 block">High Contrast Canvas</span>
                    <span className="text-xs text-slate-500">Stark dark background with high-contrast text and crisp borders</span>
                  </div>
                </div>
                <input
                  type="checkbox"
                  ...
                  onChange={e => {
                    ...
                    showToast(e.target.checked ? 'High Contrast enabled' : 'Standard Contrast restored', 'info');
                  }}
                  className="w-5 h-5 accent-teal-600 rounded cursor-pointer"
              ...
              <label className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 hover:border-teal-300 bg-slate-50/50 hover:bg-teal-50/20 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-slate-900 block">Reduced Motion</span>
                    <span className="text-xs text-slate-500">Minimizes UI transitions, pulses, and canvas animations</span>
                  </div>
                </div>
                <input
                  type="checkbox"
                  ...
                  onChange={e => {
                    ...
                    showToast(e.target.checked ? 'Reduced motion enabled' : 'Standard motion enabled', 'info');
                  }}
                  className="w-5 h-5 accent-teal-600 rounded cursor-pointer"
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 hover:border-teal-300 bg-slate-50/50 hover:bg-teal-50/20 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-slate-900 block">Visual Hand Landmarks</span>
                    <span className="text-xs text-slate-500">Overlay 21 MediaPipe hand points during camera signing</span>
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={accessibility.showLandmarks}
                  onChange={e => updateAccessibility({ showLandmarks: e.target.checked })}
                  className="w-5 h-5 accent-teal-600 rounded cursor-pointer"
              ...
              <label className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 hover:border-teal-300 bg-slate-50/50 hover:bg-teal-50/20 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-slate-900 block">Sign Player Subtitles</span>
                    <span className="text-xs text-slate-500">Display gloss and phonetic captions on sign avatar displays</span>
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={accessibility.captionsEnabled}
                  onChange={e => updateAccessibility({ captionsEnabled: e.target.checked })}
                  className="w-5 h-5 accent-teal-600 rounded cursor-pointer"
