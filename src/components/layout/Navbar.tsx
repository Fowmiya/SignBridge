      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Quick Sign Language Badge */}
            <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 text-xs font-semibold border border-slate-200" title="Active Sign Model Target">
              <span className="w-2 h-2 rounded-full bg-teal-500 animate-pulse"></span>
              <span>{signLang} Model</span>
            </div>
            ...
            <button
              ...
              title="Accessibility options (Large text, High contrast, Speech rate)"
            >
